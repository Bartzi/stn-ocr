...
def make_gif(image_dir, dest_file, pattern=r"(\d+)", image_stride=1, end=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--stride", default=1, type=int, help="use every n-th image for the gif, [default=1]")
    parser.add_argument("-e", "--end", type=int, help='maximum number of images to put in gif')

    args = parser.parse_args()

    make_gif(args.image_dir, args.dest_file, args.pattern, image_stride=args.stride, end=args.end)
